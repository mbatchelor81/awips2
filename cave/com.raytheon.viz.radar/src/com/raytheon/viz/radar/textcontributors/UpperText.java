 ...
 * Mar 05, 2013  51       zwang     Handle GFM product
 * Jul 08, 2013  17356    zwang     Tag SAILS product
 * May 02, 2017  20055    jdynina   Tag repeat elev scan products
...
public class UpperText {
    ...
    @XmlElements({ @XmlElement(name = "vcp", type = VCPTextContributor.class),
            ...
            @XmlElement(name = "productDependentRepElev", type = RepeatElevTextContributor.class),
<<<<<<< HEAD
=======

...
# 04/03/2018 - Additional fixes needed to enable Manual options to work out to 102 hours.
# 09/18/2018 - Make ISC default and have 8-hour InundationMax grid created when running
# 01/28/2020 - Return default to PHISH and change Manual cap to 20 feet
# 02/01/2021 - Fix incorrect output in manual mode. DR22542 
# ----------------------------------------------------------------------------

        ...
        if (from.equalsIgnoreCase("inHg")) {
            if (to.equalsIgnoreCase("mb")) {
                return NonSI.INCH_OF_MERCURY
                        .getConverterTo(MetricPrefix.MILLI(NonSI.BAR)).convert(
                                originalValue);
            } else if (to.equalsIgnoreCase("hPa")) {
                return NonSI.INCH_OF_MERCURY
                        .getConverterTo(MetricPrefix.HECTO(SI.PASCAL)).convert(
                                originalValue);
    ...
    public static double convertTemperatureFromTo(String from, String to,
        ...
        if (from.equalsIgnoreCase("Celsius")) {
            if (to.equalsIgnoreCase("Fahrenheit")) {
                return SI.CELSIUS.getConverterTo(USCustomary.FAHRENHEIT).convert(
                        originalValue);
            ...
            if (to.equalsIgnoreCase("Celsius")) {
                return USCustomary.FAHRENHEIT.getConverterTo(SI.CELSIUS).convert(
                        originalValue);

            } else if (to.equalsIgnoreCase("Kelvin")) {
                return USCustomary.FAHRENHEIT.getConverterTo(SI.KELVIN).convert(
                        originalValue);
            }
            ...
            if (to.equalsIgnoreCase("Celsius")) {
                ...
                return SI.KELVIN.getConverterTo(USCustomary.FAHRENHEIT).convert(
                        originalValue);
    ...
    public static double convertDistanceFromTo(String from, String to,
        ...
        if (from.equalsIgnoreCase("m")) {
            if (to.equalsIgnoreCase("km")) {
                ...
                return SI.METRE.getConverterTo(USCustomary.MILE).convert(
                        originalValue);
            } else if (to.equalsIgnoreCase("cm")) {
                return originalValue * 100;
            } else if (to.equalsIgnoreCase("ft")) {
                return SI.METRE.getConverterTo(USCustomary.FOOT).convert(
                        originalValue);
            } else if (to.equalsIgnoreCase("in")) {
                return SI.METRE.getConverterTo(USCustomary.INCH).convert(
                        originalValue);
            } else if (to.equalsIgnoreCase("Nmi")) {
                return SI.METRE.getConverterTo(USCustomary.NAUTICAL_MILE).convert(
                        originalValue);
            ...
            meters = USCustomary.MILE.getConverterTo(SI.METRE).convert(originalValue);
        } else if (from.equalsIgnoreCase("cm")) {
            meters = originalValue / 100;
        } else if (from.equalsIgnoreCase("ft")) {
            meters = USCustomary.FOOT.getConverterTo(SI.METRE).convert(originalValue);
        } else if (from.equalsIgnoreCase("in")) {
            meters = USCustomary.INCH.getConverterTo(SI.METRE).convert(originalValue);
        } else if (from.equalsIgnoreCase("Nmi")) {
            meters = USCustomary.NAUTICAL_MILE.getConverterTo(SI.METRE).convert(
                    originalValue);

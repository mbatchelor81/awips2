...
import com.raytheon.viz.satellite.SatelliteLegendLookup;
...
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
    ...
    public static final InterrogationKey<Quantity<?>> SATELLITE_DATA_INTERROGATE_KEY = new StringInterrogationKey<>(
            SATELLITE_DATA_INTERROGATE_ID,
            Interrogator.getTypedQuantityClass());
...
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
    ...
    private void initializeFirstFrame(SatelliteRecord record)
        ...
        try {
            ...
            if (dataRecord instanceof ShortDataRecord) {
                if (SatelliteUnitsUtil.isSigned(dataRecord)) {
            ...
            Unit<?> dataUnit = SatelliteUnitsUtil.getDataUnit(unit, dataRecord);
            if (dataUnit != null && unit != null
                    && dataUnit.isCompatible(unit)) {
                UnitConverter converter = UnitConv
                        .getConverterToUnchecked(dataUnit, unit);
        ...
        try {
            ...
            if (sr == null
                ...
                if (unit != null && unit.isCompatible(SI.KELVIN)) {
            ...
            sampleFormat = preferences.getSampleFormat();
    ...
    public String inspect(ReferencedCoordinate coord) throws VizException {
        ...
        if (unit != null && measuredUnit != null) {
            UnitConverter dataToDisplay = null;
            try {
                dataToDisplay = measuredUnit.getConverterToAny(unit);
                ...
                statusHandler.handle(Priority.ERROR,
                        "Unable to convert unit "
                                + stringFormat.format(measuredUnit)
                                + " to unit " + unit,
                        e);
            }
        }
        ...
        return sampleFormat.format(measuredValue, unitString);
    }
    ...
    private String getLegend(SatelliteRecord record) {
        ...
        return SatelliteLegendLookup.getLegend(productName,
    ...
    public InterrogateMap interrogate(ReferencedCoordinate coordinate,
        ...
        Quantity<?> value = Quantities.getQuantity(dataValue, dataUnit);

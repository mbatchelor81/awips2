...
public class SatelliteUnits {
    ...
    public static final Unit<Speed> RAINFALL_RATE_PIXEL = new RainfallRatePixel();
    ...
    public static void register() {
        register(SimpleUnitFormat.getInstance(SimpleUnitFormat.Flavor.ASCII));
        register(SimpleUnitFormat.getInstance(SimpleUnitFormat.Flavor.Default));

    }

    public static void register(SimpleUnitFormat format) {

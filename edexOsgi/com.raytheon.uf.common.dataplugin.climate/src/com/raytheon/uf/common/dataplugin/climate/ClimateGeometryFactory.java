...
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
    ...
    private static String buildLocationNameConstraint(String[] locationNames,
        ...
        if (locationNames.length > 0) {
            ...
            RequestConstraint inConstraint = new RequestConstraint(
                    locationNames);
            locationConstraint.append(inConstraint.toSqlString());
        }
    ...
    private static String buildDataTimesConstraint(List<String> timeColumnNames,
        ...
        if (dataTimes != null && dataTimes.length > 0) {
            if (CollectionUtils.containsAny(timeColumnNames,
                ...
                for (int i = 0; i < dataTimes.length; ++i) {
                    refTimes[i] = String.valueOf(dataTimes[i].getRefTime());
                }
                RequestConstraint in = new RequestConstraint(refTimes);
                dataTimesConstraint.append(columnName).append(in.toSqlString());
            }
        }

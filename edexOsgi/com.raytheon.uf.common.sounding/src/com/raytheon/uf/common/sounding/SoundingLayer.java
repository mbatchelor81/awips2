...
public class SoundingLayer implements Serializable, Cloneable {
    ...
    public enum DATA_TYPE {
        PRESSURE("UA_PRESSURE", MetricPrefix.HECTO(SI.PASCAL)), TEMPERATURE(
                "UA_TEMPERATURE", SI.KELVIN), DEWPOINT("UA_DEWPOINT", SI.KELVIN), WINDSPEED(
                "WINDSPEED", SI.METRE_PER_SECOND), WINDDIRECTION(
                "WINDDIRECTION", NonSI.DEGREE_ANGLE), GEO_HEIGHT("GEO_HEIGHT",
                SI.METRE), OMEGA("OMEGA", MetricPrefix.HECTO(SI.PASCAL).divide(SI.SECOND)), WIND_U(
                "WIND_U", SI.METRE_PER_SECOND), WIND_V("WIND_V",
                SI.METRE_PER_SECOND);

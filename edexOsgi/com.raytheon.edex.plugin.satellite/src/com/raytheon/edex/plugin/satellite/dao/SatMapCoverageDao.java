            ...
            if (result != null) {
                ...
                try {
                    ...
                    if (e.getCause() instanceof ConstraintViolationException) {
                         ...
                         * could have been created elsewhere between the query
                         * and the save, so requery and throw an exception if it
                         * is not found.
                         */
...
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
    ...
    public List<SatMapCoverage> queryByType(String type)
     ...
     */
    @SuppressWarnings("unchecked")
    public List<SatMapCoverage> queryByDimension(Integer nx, Integer ny)
            throws DataAccessLayerException {

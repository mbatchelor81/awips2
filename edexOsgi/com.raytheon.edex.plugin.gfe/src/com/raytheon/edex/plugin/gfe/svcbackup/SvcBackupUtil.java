 ...
 * May 23, 2017  6285     randerso     Removed authorizeWithLocalization. Code
 *                                     cleanup.
...
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
     ...
     *
     * @param activeSites
     *            if true return only active primary sites
     * @return the primary sites
     */
    public static Set<String> getPrimarySites(boolean activeSites) {
        ...
        for (String site : sites) {
            ...
            if (!siteId.isEmpty()) {
                if (!activeSites || validSites.contains(siteId)) {
                    retVal.add(siteId);
                } else {

...
## output.
##
class HIRESWarwForecaster(Forecaster):
    def __init__(self):
        Forecaster.__init__(self, "HIRESWarw")
...
####-------------------------------------------------------------------------
    def calcWind(self, wind_FHAG10):
        ...
        winddir = wind_FHAG10[1]         # get wind dir
        return (mag, winddir)           # assemble speed and dir into a tuple

...
# any purpose.
#
# CivilEmerg_HMW_<MultiPil>_Local
# This product produces a Hazardous Material Warning
#
# Author: Matt Davis
# ----------------------------------------------------------------------------
#-------------------------------------------------------------------------
...
class TextProduct(CivilEmerg.TextProduct):
    ...
    Definition["displayName"] = "CivilEmergency_HMW_<MultiPil> (Hazardous Material Warning)"
<<<<<<< HEAD
             # for Product Generation Menu               
=======
    # for Product Generation Menu               
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
    Definition["outputFile"] = "{prddir}/TEXT/HMW_<MultiPil>.txt"

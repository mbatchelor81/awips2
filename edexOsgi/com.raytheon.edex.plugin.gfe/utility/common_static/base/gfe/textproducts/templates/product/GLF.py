...
#        return {}
    ...
    def _determineTimeRanges(self, argDict):
        ...
        for i in range(0,8):
           ...
           trDict["MAFOR"+repr(i)] = periods[i][0]
    ...
    def _makeProduct(self, fcst, editArea, areaLabel, argDict):
        ...
        maforheadline = maforheadline.replace("\n", "")
    ...
    def _postProcessArea(self, fcst, editArea, areaLabel, argDict):
        ...
        # ========================================
        fcst = fcst.replace("widespread rain", "occasional rain")
        fcst = fcst.replace("widespread showers", "showers")
        fcst = fcst.replace("widespread thunderstorms", "thunderstorms")

        fcst = fcst.replace("rain showers", "showers")
        fcst = fcst.replace("thunderstorms and showers", "showers and thunderstorms")
    ...
    def _postProcessProduct(self, fcst, argDict):
        ...
        if "storm force" in fcst or \
           "storm warning" in fcst or \
           "hurricane" in fcst:
            fcst = fcst + "&&STORM\n\n"
...
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
        ...
        mafor = mafor.replace("_", " ")
        mafor = mafor.replace("HALF", "1/2")
        mafor = mafor.replace("THREE QUARTERS", "3/4")
        mafor = mafor.replace("QUARTER", "1/4")
        mafor = mafor.replace("TWO THIRDS", "2/3")
        mafor = mafor.replace("THIRD", "1/3")
        mafor = mafor.replace("LAKE SUPERIOR", "")

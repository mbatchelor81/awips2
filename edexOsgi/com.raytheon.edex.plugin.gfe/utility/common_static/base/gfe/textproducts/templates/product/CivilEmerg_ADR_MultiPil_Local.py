...
# any purpose.
#
# CivilEmerg_ADR_<MultiPil>_Local
# This product produces a Administrative Message
#
# Author: Matt Davis
# ----------------------------------------------------------------------------
#-------------------------------------------------------------------------
...
class TextProduct(CivilEmerg.TextProduct):
    ...
    Definition["displayName"] = "CivilEmergency_ADR_<MultiPil> (Administative Message)"
<<<<<<< HEAD
             # for Product Generation Menu               
=======
    # for Product Generation Menu               
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
    Definition["outputFile"] = "{prddir}/TEXT/ADR_<MultiPil>.txt"

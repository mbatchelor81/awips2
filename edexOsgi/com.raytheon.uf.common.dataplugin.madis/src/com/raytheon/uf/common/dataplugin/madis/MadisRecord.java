...
public class MadisRecord extends PersistablePluginDataObject
    ...
    public static final Unit<Temperature> TEMPERATURE_UNIT = USCustomary.FAHRENHEIT;
    ...
    public static final Unit<Length> HEIGHT_UNIT = SI.METRE;
    ...
    public static final Unit<Length> PRECIP_UNIT = USCustomary.INCH;

...
/**
 * Data Access object for interacting with parties in the registry
<<<<<<< HEAD
 * 
 * <pre>
 * 
 ...
 * @version 1.0
 */
public class PartyDao extends RegistryObjectTypeDao<PartyType> {
...
public class PartyDao extends RegistryObjectTypeDao<PartyType> {
    ...
    public PartyDao(IDaoConfigFactory daoConfigFactory) {
        super(daoConfigFactory);
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
    }

    @Override
    protected Class<PartyType> getEntityClass() {

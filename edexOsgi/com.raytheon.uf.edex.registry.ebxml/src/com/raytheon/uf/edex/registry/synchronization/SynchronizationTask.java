 ...
 * Aug 02, 2017  6186     rjpeter   Cache soap service lookup and add retry.
 * Sep 04, 2018  7238     skabasele added logic for automatic update on out of synch objects.
 * Nov 02, 2020  8261     ksuni     code to keep track if exception are thrown in individual batch tasks.
...
=======
                 ...
                 * middle of the initial sync and now is starting back up again.
                 */
                localRegistryObjectSubsetIdsOnly
                        .removeAll(initialSiteDbOjectIdsSet);
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
...
=======
                ...
                if (initialSync) {
                    /*
                     * First clear out all local registry objects except the
                     * initial DB objects. This generally should do nothing but
                     * may be needed if our local registry JVM shut down in the
                     * middle of the initial sync and now is starting back up
                     * again.
                     */
                    localRegistryObjectSubsetIdsOnly
                            .removeAll(initialSiteDbOjectIdsSet);
                    if (!localRegistryObjectSubsetIdsOnly.isEmpty()) {
                        logger.info("Purging the local database of "
                                + localRegistryObjectSubsetIdsOnly.size()
                                + " objects of type [" + objectType
                                + "] before doing initial sync");
                        synchronizeInBatches
                                .localDelete(localRegistryObjectSubsetIdsOnly);
                    }

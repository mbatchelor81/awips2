 ...
 * @version 1.0
 */
public class ClassificationTypeDao extends
        RegistryObjectTypeDao<ClassificationType> {
 ...
 * @author bphillip
 */
public class ClassificationTypeDao
        extends RegistryObjectTypeDao<ClassificationType> {

    public ClassificationTypeDao(IDaoConfigFactory daoConfigFactory) {
        super(daoConfigFactory);
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
    }

    @Override
    protected Class<ClassificationType> getEntityClass() {

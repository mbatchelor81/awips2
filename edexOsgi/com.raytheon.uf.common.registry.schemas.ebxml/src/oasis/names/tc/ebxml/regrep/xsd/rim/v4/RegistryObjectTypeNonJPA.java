...
@XmlType(name = "RegistryObjectTypeNonJPA", propOrder = { "intStringName",
...
public class RegistryObjectTypeNonJPA extends IdentifiableTypeNonJPA {
     ...
     * Constructor.
     */
    public RegistryObjectTypeNonJPA() {
        super();
     ...
     *            the lid to use
     */
    public RegistryObjectTypeNonJPA(String id, String lid) {
        this.id = id;
        this.lid = lid;

    }

    public RegistryObjectTypeNonJPA(String id, String lid, String objectType,
    ...
    public boolean equals(Object obj) {
        ...
        RegistryObjectTypeNonJPA other = (RegistryObjectTypeNonJPA) obj;
        if (classification == null) {

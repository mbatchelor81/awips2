 ...
 * 07/25/2019    7890       ksunil       set deleteChildren default to true.
...
public class RemoveObjectsRequest extends RegistryRequestType {
    ...
    @XmlAttribute
    @DynamicSerializeElement
    protected Boolean deleteChildren = true;
    ...
    public RemoveObjectsRequest(String id, String comment, List<SlotType> slots,
            QueryType query, ObjectRefListType objectRefList,
            Boolean checkReferences, Boolean deleteChildren,

 ...
 * Jul 24, 2012  955      djohnson  Check for a specific object type to be specified on {@link
 *                                  RegistryObject}.
 * Aug 03, 2012  724      bphillip  Additions to support assigning ownership to registry objects
 * Aug 20, 2012  743      djohnson  Slot converter for {@link ImmutableDate}, and enumerations.
 * Sep 07, 2012  1102     djohnson  Check in hanging around encoding strategy code that will prove
 *                                  useful later.
 * Oct 05, 2012  1195     djohnson  Don't persist slots for null values.
 * Apr 09, 2013  1802     bphillip  Pulled constants out into existing constants package that was
 *                                  moved into common
 ...
 * Jun 05, 2014  1712     bphillip  Registry now communicates over https
 * Jun 25, 0201  3273     dhladky   Remove all DD environment variables from setup.env
...
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
    ...
    static {
        Map<String, SlotConverter> map = new HashMap<>(11, 1);
...
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
                ...
                registryObject.setName(ReflectionUtil.getAnnotatedField(
                        registryObject, RegistryObjectName.class));
                registryObject.setDescription(ReflectionUtil.getAnnotatedField(
                        registryObject, RegistryObjectDescription.class));
                ...
                // We need the actual payload class, not just it's ID for
                // version comparisons
                String clazz = object.getClass().getCanonicalName();
                SlotType classNameSlot = new SlotType(registryObjectClassName,
                        new StringValueType(clazz));
    ...
    public static Map<String, RegistryObjectType> getAssociatedObjects(
        ...
        Map<String, RegistryObjectType> ids = new HashMap<>();

 ...
 * Aug 09, 2018  6720     njensen   Remove usage of display name
...
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
        ...
        if (isGuidance(source)) {
            Number accumulationTime = extractIdentifierValue(request, ACCUM_HRS,
                    Number.class);
            basinData = cache.getSourceData(siteKey, source.getSourceName())
        ...
        if (source.getSourceType() == SourceType.QPE) {
            rateOrAccum = source.getRateOrAccum(siteKey).name();
        }

        boolean isRate = true;
        /*
         * FIXME randerso: Regarding comment and behavior below, looking at the
...
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
         ...
         * RATE data as RATEs after it has been accumulated (i.e. converted to
         * ACCUM).
         */
         ...
         */
        if (rateOrAccum != null && RateOrAccum
                .valueOf(rateOrAccum.toUpperCase()) == RateOrAccum.RATE) {
            isRate = false;
        }
...
>>>>>>> 3a1a5c9814b49f276bea4ebd9e584974d6ea7a11
    ...
    private FFMPGuidanceInterpolation getGuidanceInterpolation(
        ...
        ProductXML product = sourceConfig
                .getProductByPrimarySourceName(primarySourceName);
        ...
        FFMPGuidanceInterpolation interpolator = new FFMPGuidanceInterpolation(
                ...
                source.getSourceFamily(), siteKey);
